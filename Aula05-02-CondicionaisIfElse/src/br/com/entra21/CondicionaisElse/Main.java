package br.com.entra21.CondicionaisElse;
...
public class Main {
	...
	public static void main(String[] args) {
	 ...
	 if(false) {
		 ...
		 System.out.println("Vai passar aqui quando a condição resultar em falsa");
		 }
	 byte idade=18;
	 ...
	 if(idade>17) {//é maior de idade?
		 ...
		 System.out.println("Não é permetido menore aqui!!!");
	 }
	 }
